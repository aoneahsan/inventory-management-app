...
export const validationMessages = {
  item: {
    ...
    nameTooLong: `Item name must be less than ${appLimits.item.nameMaxLength} characters`,
    invalidQuantity: "Quantity must be a non-negative number",
    invalidPrice: "Price must be a non-negative number",
    tooManyImages: `Maximum ${appLimits.item.imagesMax} images allowed`,
    tooManyTags: `Maximum ${appLimits.item.tagsMax} tags allowed`,
  },

  organization: {
    nameRequired: "Organization name is required",
    nameTooLong: `Organization name must be less than ${appLimits.organization.nameMaxLength} characters`,
