      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFeatureCard(
            context,
            title: 'Data Export',
            subtitle: 'Export your data in CSV, JSON, or XML formats',
            icon: Icons.download,
            color: Colors.amber,
          ...
          _buildFeatureCard(
            ...
            subtitle: 'Visualize your data with interactive charts',
            icon: Icons.bar_chart,
            color: Colors.deepPurple,
            onTap: () => context.push('/analytics/charts'),
          ),
          const SizedBox(height: 12),
          _buildFeatureCard(
            context,
            title: 'Backup & Restore',
            subtitle: 'Backup your data to cloud and restore when needed',
            icon: Icons.backup,
            color: Colors.cyan,
          ...
          _buildFeatureCard(
            ...
            subtitle: 'Build and save custom reports for your needs',
            icon: Icons.assessment,
            color: Colors.lime,
            onTap: () => context.push('/reports/custom'),
          ),
        ],
      ),
    );
